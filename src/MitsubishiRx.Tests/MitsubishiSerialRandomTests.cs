...
{
    /// <summary>Executes the RandomReadWordsAsyncSerial3CFormat1EncodesExpectedRequestAndParsesResponse operation.</summary>
    /// <returns>The RandomReadWordsAsyncSerial3CFormat1EncodesExpectedRequestAndParsesResponse operation result.</returns>
    [Test]
    ...
    /// <summary>Executes the RandomReadWordsAsyncSerial4CFormat5EncodesExpectedRequestAndParsesResponse operation.</summary>
    /// <returns>The RandomReadWordsAsyncSerial4CFormat5EncodesExpectedRequestAndParsesResponse operation result.</returns>
    [Test]
