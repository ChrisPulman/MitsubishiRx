...
{
    /// <summary>Stores the s_metadata field.</summary>
    private static readonly ReadOnlyDictionary<string, MitsubishiDeviceMetadata> s_metadata = new(new Dictionary<string, MitsubishiDeviceMetadata>(StringComparer.OrdinalIgnoreCase) { ["X"] = new("X", 0x9C, 0x5820, DeviceValueKind.Bit, DeviceNumberFormat.XyVariable), ["Y"] = new("Y", 0x9D, 0x5920, DeviceValueKind.Bit, DeviceNumberFormat.XyVariable), ["M"] = new("M", 0x90, 0x4D20, DeviceValueKind.Bit, DeviceNumberFormat.Decimal), ["L"] = new("L", 0x92, 0x4C20, DeviceValueKind.Bit, DeviceNumberFormat.Decimal), ["B"] = new("B", 0xA0, 0x4220, DeviceValueKind.Bit, DeviceNumberFormat.Hexadecimal), ["D"] = new("D", 0xA8, 0x4420, DeviceValueKind.Word, DeviceNumberFormat.Decimal), ["W"] = new("W", 0xB4, 0x5720, DeviceValueKind.Word, DeviceNumberFormat.Hexadecimal), ["R"] = new("R", 0xAF, 0x5220, DeviceValueKind.Word, DeviceNumberFormat.Decimal), ["ZR"] = new("ZR", 0xB0, 0x5A52, DeviceValueKind.Word, DeviceNumberFormat.Hexadecimal), ["TN"] = new("TN", 0xC2, 0x544E, DeviceValueKind.Word, DeviceNumberFormat.Decimal), ["TS"] = new("TS", 0xC1, 0x5453, DeviceValueKind.Bit, DeviceNumberFormat.Decimal), ["TC"] = new("TC", 0xC0, 0x5443, DeviceValueKind.Bit, DeviceNumberFormat.Decimal), ["CN"] = new("CN", 0xC5, 0x434E, DeviceValueKind.Word, DeviceNumberFormat.Decimal), ["CS"] = new("CS", 0xC4, 0x4353, DeviceValueKind.Bit, DeviceNumberFormat.Decimal), ["CC"] = new("CC", 0xC3, 0x4343, DeviceValueKind.Bit, DeviceNumberFormat.Decimal), ["SM"] = new("SM", 0x91, 0x534D, DeviceValueKind.Bit, DeviceNumberFormat.Decimal), ["SD"] = new("SD", 0xA9, 0x5344, DeviceValueKind.Word, DeviceNumberFormat.Decimal), });
    ...
    public static MitsubishiDeviceAddress Parse(string value, XyAddressNotation addressNotation = XyAddressNotation.Octal)
    {
